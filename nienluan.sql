...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 16, 2022 lúc 09:27 AM
...
--
ALTER TABLE `chitiet_sanpham`
  MODIFY `ma_ctsp` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `hinh`
  MODIFY `ma_h` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=234;
...
--
ALTER TABLE `sanpham`
  MODIFY `ma_sp` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
