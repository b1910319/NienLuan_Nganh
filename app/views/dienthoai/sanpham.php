<div class="list_sanpham mt-4 container">
  ...
  <div class="row mb-4 timkiem_hang ">
    <div class="col-2 p-3 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_iphone.png" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
    <div class="col-2 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_samsung.png" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
    <div class="col-2 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_oppo.jpg" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
    <div class="col-2 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_xiaomi.png" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
    <div class="col-2 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_vivo.png" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
    <div class="col-2 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_realme.png" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
    <div class="col-2 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_nokia.jpg" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
    <div class="col-2 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_mobell.jpg" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
    <div class="col-2 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_itel.jpg" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
    <div class="col-2 p-3 btn_hang">
      <a href="">
        <img src="./img/logo/logo_masstel.png" class="d-block w-100" style="border-radius:20px ;">
      </a>
    </div>
  </div>
