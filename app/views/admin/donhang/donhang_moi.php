        ...
        foreach ($data['donhang_moi'] as $key => $dh) {
          ...
          ?>
            <tr>
              ...
              <td style="width: 10%;"><?php echo $dh['ma_dh'] ?></td>
              <td style="width: 15%;"><?php echo number_format($dh['tonggia_dh'], 0, ',', '.') . ' <sup>đ</sup>' ?></td>
              ...
              <td style="width: 25%;">
                ...
                ?>
                  <button type="button" class="btn vanchuyen" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Đơn hàng đang vận chuyển">
